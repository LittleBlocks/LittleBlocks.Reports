...
{
    public interface IReportOutputExtender<in TRequest> where TRequest : ReportRequest
    {
        Task ExtendReportOutputAsync(ReportOutputStream outputStream, TRequest request);
    }
}