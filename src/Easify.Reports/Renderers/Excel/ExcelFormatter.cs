...
{
    public abstract class ExcelFormatter<T> : IExcelFormatter<T>
    {
        ...
        {
            if (data == null)
                return new SectionData { HeaderRange = SectionHeader, DataRange = SectionData };
            ...
            return new SectionData
            {
                ...
                Data = data.Select(GetProperties).ToList()
            };
        }

        protected abstract object[] GetProperties(T snapshot);
        protected abstract object[] GetHeader();
    }
}