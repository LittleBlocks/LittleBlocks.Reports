...
namespace LittleBlocks.Reports.Model
{
    public class SnapshotCollection
    {
        ...
        {
            Items = new List<Snapshot>();
        }

        public SnapshotCollection(string snapshotType, IEnumerable<Snapshot> snapShots)
        {
            if (snapshotType == null) throw new ArgumentNullException(nameof(snapshotType));
